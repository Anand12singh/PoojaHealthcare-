...
// if (document.getElementById('featured_media') != undefined) {
//     document.getElementById('featured_media').addEventListener('change', function (event) {
//         const file = event.target.files[0];
//         const errorMessage = document.querySelector('.featured_media-error');
...
//                 errorMessage.textContent = 'Image dimensions must not exceed 1200px width and 700px height.';
//                 return;
//             }
